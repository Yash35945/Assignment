...
(function() {
  ...
  for (let card of cards) {
    const description = card.querySelector(".read-more__content");
    const readMore = card.querySelector(".seemorebutton");
  ...
  function openCity(evt, cityName) {
    ...
    for (i = 0; i < tabcontent.length; i++) {
      ...
      //tabcontent[i].classList.add("mystyle");
    }
    ...
    //document.getElementById(cityName).classList.remove("mystyle");
