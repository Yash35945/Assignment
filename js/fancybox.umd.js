!function(t, e) {
    ...
    class k extends g {
        ...
        onPointerDown(t, e, i) {
            ...
            if (!i.length) {
                if (["TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO", "IFRAME"].includes(o.nodeName) || o.closest("[contenteditable]") || o.closest("[data-selectable]") || o.closest("[data-draggable]") || o.closest("[data-clickable]") || o.closest("[data-panzoom-change]") || o.closest("[data-panzoom-action]"))
                    return !1;
        ...
        updateControls() {
            ...
            let d = {
              ...
              , m = p && f;
            f && (e(r) < e(h) && !this.panOnlyZoomed && (m = !0),
    ...
    class dt extends N {
        ...
        setAspectRatio(t) {
            ...
            if (!(s && a && o && 1 !== o && t.type && ["video", "youtube", "vimeo", "html5video"].includes(t.type)))
                return;
            const r = a.width
              , l = a.height;
    ...
    class St extends N {
        ...
        onInit() {
            ...
            e.option("showOnStart") || (e.ref.state = vt.Hidden,
            e.hidden = !0)
        }
        onResize() {
            var t;
    ...
    class Wt extends g {
        ...
        initLayout() {
            ...
            Ht && Bt || (Ht = document.createElement("span"),
        ...
        initCarousel(t) {
            ...
            s.on(["refresh", "change"], (t=>{
                ...
                for (const t of e.querySelectorAll("[data-fancybox-download]")) {
                    ...
                    n ? (t.removeAttribute(s),
                    t.removeAttribute(o),
                    t.setAttribute(r, n),
                    t.setAttribute(a, e || n),
                    t.setAttribute("target", "_blank")) : (t.setAttribute(s, ""),
                    t.setAttribute(o, "-1"),
                    t.removeAttribute(r),
                    t.removeAttribute(a))
                }
        ...
        manageCaption(t=void 0) {
            ...
            h && (h.innerHTML = "",
            "string" == typeof c ? h.innerHTML = c : c instanceof HTMLElement && h.appendChild(c))
        }
        checkFocus(t) {
            var e;
        ...
        focus(t) {
            ...
            l.length && (i === Bt ? h = l[0] : this.lastFocus !== s && i !== Ht || (h = l[l.length - 1]))) : h = o && "image" === o.type ? s : c || s,
            h && tt(h),
        ...
        hideLoading(t) {
            ...
            if (!e)
                return;
            const i = t.spinnerEl;
            this.isClosing() ? null == i || i.remove() : (S(e, Ft),
